...
#define PanSource	"finalpractice.pml"
...
#define _nstates6	19	/* redStrictlyBeforeWalk */
#define minseq6	63
#define maxseq6	80
#define _endstate6	18

#define _nstates5	14	/* pedestrianCanCross */
#define minseq5	50
#define maxseq5	62
#define _endstate5	13

#define _nstates4	11	/* safePedestrian */
#define minseq4	40
#define maxseq4	49
#define _endstate4	10

#define _nstates3	9	/* initialState_INIT */
#define minseq3	32
#define maxseq3	39
#define _endstate3	8

#define _nstates2	10	/* Ped */
#define minseq2	23
#define maxseq2	31
#define _endstate2	9

#define _nstates1	12	/* VL */
#define minseq1	12
#define maxseq1	22
#define _endstate1	11

#define _nstates0	13	/* PL */
#define minseq0	0
#define maxseq0	11
...
typedef struct P6 { /* redStrictlyBeforeWalk */
...
typedef struct P5 { /* pedestrianCanCross */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P4 { /* safePedestrian */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P3 { /* initialState_INIT */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define PPed	((P2 *)_this)
typedef struct P2 { /* Ped */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#else
	#define ACCEPT_LAB	7 /* user-defined accept labels */
#endif
#ifdef MEMCNT
	#ifdef MEMLIM
