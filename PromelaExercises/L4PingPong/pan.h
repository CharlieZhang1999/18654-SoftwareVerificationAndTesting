...
#define PanSource	"JugglersBW.pml"
...
#define _nstates8	11	/* alwaysDifferentColors */
#define minseq8	110
#define maxseq8	119
#define _endstate8	10

#define _nstates7	14	/* notPossiblyAllBallsAreDropped_FAIL */
#define minseq7	97
#define maxseq7	109
#define _endstate7	13

#define _nstates6	14	/* notEventuallyAlwaysGameOn_FAIL */
#define minseq6	84
#define maxseq6	96
#define _endstate6	13

#define _nstates5	32	/* alwaysEventuallyTwoBalls */
#define minseq5	53
#define maxseq5	83
#define _endstate5	31

#define _nstates4	11	/* alwaysAtMostTwoBalls */
#define minseq4	43
#define maxseq4	52
#define _endstate4	10

#define _nstates3	14	/* alwaysEventuallyGameOn */
#define minseq3	30
#define maxseq3	42
...
#define _nstates1	18	/* Player */
#define minseq1	9
#define maxseq1	25
#define _endstate1	17

#define _nstates0	10	/* Referee */
#define minseq0	0
#define maxseq0	8
#define _endstate0	9
...
typedef struct P8 { /* alwaysDifferentColors */
...
typedef struct P7 { /* notPossiblyAllBallsAreDropped_FAIL */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P6 { /* notEventuallyAlwaysGameOn_FAIL */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P5 { /* alwaysEventuallyTwoBalls */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P4 { /* alwaysAtMostTwoBalls */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P3 { /* alwaysEventuallyGameOn */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
