package junit.fitnesse.triangle;
...
@Suite("FitNesse.MyFitExamples.TriangleExample.TriangleSuite") // defined relative to FitNesseRoot directory
...
public class TriangleFitnesseSuite {
